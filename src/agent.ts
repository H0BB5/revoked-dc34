 ...
 *      stolen credential without this key is refused (spec §11.8).
 *
...
export async function runAgentSend(options: {
  ...
  //
  // sessionId quirk (upstream finding #2): generateRequestProof defaults a
  ...
  // replay safety rides on the per-call nonce. Filing upstream.
