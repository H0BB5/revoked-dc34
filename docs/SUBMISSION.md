...
3. 0:50–1:10 — `[2]` 100 CHEQ → refusal ("the cap is in the credential, not the app"), then `[5]` theft-replay → holder_binding_failed ("stolen credential, wrong key — subject-bound, not bearer").
